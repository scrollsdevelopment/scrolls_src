...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Scrolls: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Scrolls Signed Message:\n";
...
static const int64 nTargetTimespan = 12 * 60 * 60; // every 12 hours
static const int64 nTargetSpacing = 42; // 42 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal scrolls miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Scrolls", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1401725646;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1892004;
        ...
        assert(block.hashMerkleRoot == uint256("0x9a2945c8d78e3c6dee443354dbb096c42bba64e86e92c1a706e58cfa163a9fc8"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // scrollsd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
